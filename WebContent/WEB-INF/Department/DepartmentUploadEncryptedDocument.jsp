...
<title>Upload document with encryption</title>
</head>
<body>
...
<div class="outer-box-container">
	...
	<img src="images/dms-banner.jpg" class="banner">
		...
		<div class="operation">
		<s:form action="department_uploadencrypteddocument" method="post" enctype="multipart/form-data">
		<s:actionmessage/>
		<s:actionerror/>
		<s:file name="document" label="Document" />
		<s:actionerror/>
		<s:textfield name="EncryptionKey" label="Key Phrase"></s:textfield>
