...
<title>Administrator: View New User Requests</title>
</head>
<body>
...
<div class="outer-box-container">
	...
	<img src="images/dms-banner.jpg" class="banner">
		...
		<div class="operation">
		<div class="op_header">View Account Requests</div>
			<s:actionmessage />
	<table>
		<tr>
			<th>ID</th>
		...
		<s:iterator value="newrequest" status="newrequestStatus">
			<s:form action="AdminAction" method="POST" validate="true">
				<tr>
					<td><s:textfield size="4" name="userid" readonly="true" value="%{userid}" /></td>
					<td><s:label name="firstname" readonly="true" value="%{firstname}" style="padding:30px;" /></td>
					<td><s:label name="lastname" readonly="true" value="%{lastname}" style="padding:30px;" /></td>
					<td><s:label name="email" readonly="true" value="%{email}" style="padding:30px;" /></td>
					<td><s:select headerKey="-1" headerValue="Select Designation" list="designation_names" name="curr_designation" /></td>
					<td><s:checkboxlist list="department_names" name="curr_department" theme="vertical-checkbox" /></td>
					<td><s:submit type="button" value="Approve" method="approve_request" /> 
					<s:submit type="button" value="Deny" method="deny_request" /></td>
				</tr>
			</s:form>
		</s:iterator>
	</table>
