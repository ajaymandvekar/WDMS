...
<div class="outer-box-container">
	...
	<img src="images/dms-banner.jpg" class="banner">
		...
		<div class="op_header">System Log File</div>
		<div class="operation">
		<table>
			<tr>
				<th>ID</th>
			...
			<s:iterator value="logentries" status="newlog">
			<s:form action="AdminAction" method="POST" validate="true">
				<tr>
					<td>
						<s:label name="logid" readonly="true"  value="%{logid}" style="padding:10px;"/>
					</td>
					<td>
						<s:label name="doc_name" readonly="true"  value="%{docname}" style="padding:30px;"/>
					</td>
					<td>
						<s:label name="doc_owner" readonly="true"  value="%{docowner}" style="padding:30px;"/>
					</td>
					<td>
						<s:label name="last_access_by" readonly="true"  value="%{lastaccessby}" style="padding:30px;"/>
					</td>
					<td>
						<s:label name="access_date_time" readonly="true"  value="%{accessdatetime}" style="padding:20px;"/>
					</td>
					<td>
						<s:label name="op_type" readonly="true"  value="%{optype}" style="padding:20px;"/>
					</td>
					<td>
						<s:label name="op_desc" readonly="true"  value="%{opdesc}" style="padding:30px;"/>
					</td>
					<td>
						<s:label name="op_result" readonly="true"  value="%{opresult}" style="padding:30px;"/>
					</td>
				</tr>
			</s:form>
			</s:iterator>
